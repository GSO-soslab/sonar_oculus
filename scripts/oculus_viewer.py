...
def ping_callback(msg):
    raw = rospy.get_param('/rov/sensors/sonar/Raw', False)
    cm = rospy.get_param('/rov/sensors/sonar/Colormap', 1)
    if raw:
...
if __name__ == '__main__':
    ...
    img_pub = rospy.Publisher('/rov/sensors/sonar/image', Image, queue_size=10)
    ping_sub = rospy.Subscriber('/rov/sensors/sonar/ping', OculusPing,
